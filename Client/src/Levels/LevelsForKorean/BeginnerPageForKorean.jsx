...
import '../../styles/LevelOfKorean/BeginnerPageForKorean.css';

const BeginnerPageForKorean = () => {
  ...
  useEffect(() => {
    const fetchWords = async () => {
      try {
        ...
        const response = await fetch(`http://localhost:8000/korean-words?userId=${userId}`);
  ...
  return (
    <div className="beginner-page-wrapper-for-korean">
      <div className="beginner-page-container-for-korean">
        <h1 className="beginner-page-heading-for-korean">초급 단어 (Beginner Words)</h1>
        <ul className="word-list-for-beginner-korean">
...
export default BeginnerPageForKorean;
